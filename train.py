...
######## CHUNK 1
        if mixed_precision_dtype is None:
            ...
            self.ctx = torch.amp.autocast(device=f"cuda:{self.gpu_id}", dtype=mixed_precision_dtype)
...
##### CHUNK 6  
    ...
    # Create LoRA model
    model = LoraModelForCasualLM(model, lora_config) # REMEMBER TO UNCOMMENT THIS WHEN FINISH Q1, Q2
